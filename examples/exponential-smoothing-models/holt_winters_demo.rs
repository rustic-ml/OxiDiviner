...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!("Creating Holt-Winters model with alpha = 0.2, beta = 0.1, gamma = 0.3, period = {}...", period);
...
fn compare_gamma_values(train_data: &TimeSeriesData, test_data: &TimeSeriesData, period: usize) -> Result<(), Box<dyn Error>> {
