...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!(
        "to be followed by more high volatility, and low volatility by more low volatility.\n"
    );
    ...
    println!(
        "you would use the actual OxiDiviner API to fit GARCH models and forecast volatility."
    );
